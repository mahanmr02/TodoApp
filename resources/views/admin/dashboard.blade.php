...
@section('content')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
            <div class="bg-white p-6 rounded-xl shadow-md flex items-center justify-between transition-transform transform hover:scale-105">
                <div>
                    <p class="text-xl text-gray-900 font-bold">تعداد کل کارها</p>
                    <div class="flex items-center space-x-2 space-x-reverse mt-1">
                        <p class="text-xs text-gray-500 font-semibold">امروز</p>
                        <p id="total-tasks-today" class="text-sm font-bold text-gray-900">3</p>
                    </div>
                    <div class="flex items-center space-x-2 space-x-reverse mt-1">
                        <p class="text-xs text-gray-500 font-semibold">کل</p>
                        <p id="total-tasks-all" class="text-sm font-bold text-gray-900">3</p>
                    </div>
                </div>
            ...
            <div class="bg-white p-6 rounded-xl shadow-md flex items-center justify-between transition-transform transform hover:scale-105">
                <div>
                    <p class="text-xl text-gray-900 font-bold">کارهای انجام شده</p>
                    <div class="flex items-center space-x-2 space-x-reverse mt-1">
                        <p class="text-xs text-gray-500 font-semibold">امروز</p>
                        <p id="completed-tasks-today" class="text-sm font-bold text-gray-900">1</p>
                    </div>
                    <div class="flex items-center space-x-2 space-x-reverse mt-1">
                        <p class="text-xs text-gray-500 font-semibold">کل</p>
                        <p id="completed-tasks-all" class="text-sm font-bold text-gray-900">1</p>
                    </div>
                </div>
            ...
            <div class="bg-white p-6 rounded-xl shadow-md flex items-center justify-between transition-transform transform hover:scale-105">
                <div>
                    <p class="text-xl text-gray-900 font-bold">کارهای در حال انجام</p>
                    <div class="flex items-center space-x-2 space-x-reverse mt-1">
                        <p class="text-xs text-gray-500 font-semibold">امروز</p>
                        <p id="doing-tasks-today" class="text-sm font-bold text-gray-900">2</p>
                    </div>
                    <div class="flex items-center space-x-2 space-x-reverse mt-1">
                        <p class="text-xs text-gray-500 font-semibold">کل</p>
                        <p id="doing-tasks-all" class="text-sm font-bold text-gray-900">2</p>
                    </div>
                </div>
            ...
            <div class="bg-white p-6 rounded-xl shadow-md flex items-center justify-between transition-transform transform hover:scale-105">
                <div>
                    <p class="text-xl text-gray-900 font-bold">کارهای انجام نشده</p>
                    <div class="flex items-center space-x-2 space-x-reverse mt-1">
                        <p class="text-xs text-gray-500 font-semibold">امروز</p>
                        <p id="pending-tasks-today" class="text-sm font-bold text-gray-900">2</p>
                    </div>
                    <div class="flex items-center space-x-2 space-x-reverse mt-1">
                        <p class="text-xs text-gray-500 font-semibold">کل</p>
                        <p id="pending-tasks-all" class="text-sm font-bold text-gray-900">2</p>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-md p-6">
            <h3 class="text-xl font-semibold mb-4 text-gray-900">لیست کارهای ثبت شده اخیر</h3>
            ...
            <div id="todo-list" class="space-y-4">
                ...
                <div class="bg-gray-50 p-4 rounded-lg shadow-sm flex items-center justify-between">
                    <div>
                        <p class="text-lg font-medium text-gray-900">طراحی رابط کاربری جدید</p>
                        <p class="text-sm text-gray-500 mt-1">وضعیت: <span class="text-yellow-600">در حال انجام</span></p>
                    </div>
                </div>
                <!-- کار 2 (انجام شده) -->
                <div class="bg-gray-50 p-4 rounded-lg shadow-sm flex items-center justify-between opacity-70 line-through">
                    <div>
                        <p class="text-lg font-medium text-gray-900">نوشتن مستندات پروژه</p>
                        <p class="text-sm text-gray-500 mt-1">وضعیت: <span class="text-green-600">انجام شده</span></p>
                    </div>
                </div>
                <!-- کار 3 (در حال انجام) -->
                <div class="bg-gray-50 p-4 rounded-lg shadow-sm flex items-center justify-between">
                    <div>
                        <p class="text-lg font-medium text-gray-900">برنامه‌ریزی برای جلسه</p>
                        <p class="text-sm text-gray-500 mt-1">وضعیت: <span class="text-yellow-600">در حال انجام</span></p>
                    </div>
                </div>
            </div>
